...
module.exports = function(app, socketsApi){
    ...
    app.get('/api/session/:sessionId/results', api.getSessionResults);
    app.get('/api/session/:sessionId/assessment/:assessmentId/results', api.getAssessmentResults);

    /* POST methods */
    app.post('/api/session', function(req, res){
        api.postSession(req, res).done(socketsApi.created);
    });
    app.post('/api/session/:id', function(req, res){
        api.postSessionResult(req, res).done(socketsApi.created);
    });
    ...
    app.post('/api/session/:sessionId/assessment/:assessmentId/result', function(req, res){
        api.postAssessmentResult(req, res).done(socketsApi.created);
    });
    ...
    app.put('/api/session/:sessionId/assessment/:assessmentId', function(req, res){
        api.endAssessment(req, res).done(socketsApi.closed)
    });
